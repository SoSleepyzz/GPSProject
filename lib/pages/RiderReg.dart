...
class RiderRegPage extends StatefulWidget {
  const RiderRegPage({super.key});

  @override
  State<RiderRegPage> createState() => _RiderRegPageState();
}

class _RiderRegPageState extends State<RiderRegPage> {
